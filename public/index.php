...
// attachment name
$filename = $_FILES['contact']['name']['file'];

//$pdfdoc is PDF generated by FPDF
$attachment = chunk_split(base64_encode(file_get_contents($_FILES['contact']['tmp_name']['file'])));
...
*/
	...
	echo "\n\nFILE:";
	if ($_FILES['contact']['error']['file'] > 0) {
		echo "\n\tERROR:\n\t\t" . $_FILES['contact']['file']['error'];
	}
	else {
		echo "\n\tNAME:\n\t\t" . $_FILES['contact']['name']['file'];
		echo "\n\tTYPE:\n\t\t" . $_FILES['contact']['type']['file'];
		echo "\n\tSIZE:\n\t\t" . ($_FILES['contact']['size']['file'] / 1024) . " kB";
		echo "\n\tPATH:\n\t\t" . $_FILES['contact']['tmp_name']['file'];
	}
}
?>
		</pre>
