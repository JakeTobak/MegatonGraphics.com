...
if($option['type'] == 'file' && $this->config->get('upload_product_status') && $this->config->get('upload_product_store') != "" && in_array($this->config->get('config_store_id'), explode(',', $this->config->get('upload_product_store')))) {
