...
if($this->config->get('upload_order_status') && $this->config->get('upload_order_store') != "" && in_array($this->config->get('config_store_id'), explode(',', $this->config->get('upload_order_store'))) && $this->config->get('upload_order_minimum') && (!isset($this->session->data['order_upload']) || count($this->session->data['order_upload']) < $this->config->get('upload_order_minimum'))) { $this->redirect($this->url->link('checkout/cart')); }
