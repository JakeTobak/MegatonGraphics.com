...
if ($this->config->get('upload_order_status') && $this->config->get('upload_order_store') != "" && in_array($this->config->get('config_store_id'), explode(',', $this->config->get('upload_order_store'))) && isset($this->session->data['order_upload']) && !empty($this->session->data['order_upload'])) {
...
$template->data['copu_order'] = false;
